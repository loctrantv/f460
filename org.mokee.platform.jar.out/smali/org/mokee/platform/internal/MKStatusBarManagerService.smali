...
.method private checkDosProtection(Ljava/lang/String;II)Z
    ...
    .local v1, "count":I
    :try_start_0
    iget-object v5, p0, Lorg/mokee/platform/internal/MKStatusBarManagerService;->mQSTileList:Ljava/util/ArrayList;
    ...
    iget-object v5, v4, Lorg/mokee/internal/statusbar/ExternalQuickSettingsRecord;->sbTile:Lmokee/app/StatusBarPanelCustomTile;

    invoke-virtual {v5}, Lmokee/app/StatusBarPanelCustomTile;->getPackage()Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lmokee/app/StatusBarPanelCustomTile;->getUserId()I
    ...
    .line 335
    const-string/jumbo v5, "MKStatusBarManagerService"
